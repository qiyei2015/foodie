...
import com.qiyei.common.enums.PayMethod;
...
public class OrdersController extends BaseController {
    ...
    public Response<String> create(@RequestBody SubmitOrderBO submitOrderBO, HttpServletRequest request, HttpServletResponse response) {
        ...
        // 1. 创建订单
        OrderVO orderVO = mOrdersService.createOrder(submitOrderBO);
...
//        CookieUtils.setCookie(request, response, FOODIE_SHOPCART, "", true);
        ...
        ResponseEntity<Response> responseEntity =
                mRestTemplate.postForEntity(paymentUrl,
                                            entity,
                                            Response.class);
    ...
    public Integer notifyMerchantOrderPaid(String merchantOrderId) {
        mOrdersService.updateOrderStatus(merchantOrderId, OrderStatusEnum.WAIT_DELIVER.type);
    ...
    public Response getPaidOrderInfo(String orderId) {
        ...
        OrderStatus orderStatus = mOrdersService.queryOrderStatus(orderId);
